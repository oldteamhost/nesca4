...
# MINI-BUGS
## Вы можете помочь их исправить, пишите в тг https://t.me/Lomasterrr
...
- На некоторых cidr или range может вызывать segmentation error, исправляеться аргументом `-no-get-path`.
