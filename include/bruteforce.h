...
class brute_ftp_data{
    ...
    public:
        std::string
	   get_success_login(void);
        std::string
	   get_success_pass(void);
        void 
	   set_success_login(std::string success_login);
        void
...
// bruteforce http
std::string 
brute_http(const std::string ip, const std::string login, const std::string pass, const int verbose);
// on threads
std::string 
